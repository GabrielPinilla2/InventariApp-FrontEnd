...
const SellerForm = ({ onSubmit, initialData }) => {
  const [form, setForm] = useState( initialData || {
    idperson: '', name: '', typeId: '', identification: '', adress: '', phone: '', state: false 
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit(form);
    setForm({ idperson: '', name: '', typeId: '', identification: '', adress: '', phone: '', state: false });
  };
  ...
  return (
    <>
    {/* <h2>{initialData ? "Editar Vendedor" : "Crear Vendedor"}</h2> */}
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-8">
            <label className="form-text-label" htmlFor="name">Nombre de Vendedor</label>         
            <input
              className="form-control mb-2"
              id="name"
              name="name"
